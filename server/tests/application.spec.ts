...
const com1: Comment = {
  ...
  text: 'com1',
  commentBy: 'com_by1',
  commentDateTime: new Date('2023-11-18T09:24:00'),
};
...
describe('application module', () => {
  ...
  describe('Comment model', () => {
    ...
    describe('addComment', () => {
      test('addComment should return the updated question when given `question` with 2 length', async () => {
        const question = QUESTIONS[0];
        question.comments.push(com1);
        mockingoose(QuestionModel).toReturn(question, 'findOneAndUpdate');
