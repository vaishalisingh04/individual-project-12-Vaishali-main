...
export interface AddCommentRequest extends Request {
  body: {
    id: string; // Unique identifier of the question or answer
    type: 'question' | 'answer'; // Type of the comment target
    comment: {
      text: string; // Content of the comment
      commentBy: string; // Username of the commenter
      commentDateTime: Date; // Date and time of the comment
    };
  };
}
