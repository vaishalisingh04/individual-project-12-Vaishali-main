...
interface QuestionBodyProps {
  ...
  text: string; // Content of the question
  askby: string; // Username of the user who asked the question
  meta: string; // Additional metadata related to the question
}
 ...
 */
const QuestionBody: React.FC<QuestionBodyProps> = ({ views, text, askby, meta }) => (
